...
# training loop with memory tracking for ResNet
def train_model(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, classes=None):
    ...
    results_dir = "training_results_CIFAR10resNet"
...
def plot_metrics_per_class(results, classes, results_dir="training_results_CIFAR10resNet"):
...
def create_class_performance_dashboard(y_true, y_pred, classes, results, results_dir="training_results_CIFAR10resNet"):
    """
    ...
    plt.suptitle('ResNet18 Performance on CIFAR-10: Class-Level Analysis', fontsize=16)
...
def plot_memory_usage(results, results_dir="training_results_CIFAR10resNet"):
...
# Calculate comprehensive energy and power metrics
...
if __name__ == "__main__":
    ...
    # Data loading and preprocessing (same as original script)
    ...
    # Train the model with improved metrics collection
    ...
    plot_training_results(training_results, class_names)
    ...
    cm = plot_confusion_matrix(
        ...
        save_dir="training_results_CIFAR10resNet"
    )
    ...
    print("\nAll result visualizations have been saved to the 'training_results_CIFAR10resNet' directory.")